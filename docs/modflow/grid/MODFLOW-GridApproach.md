...
|---|---|---|
| None | GMS Core, MODFLOW Interface | 35--55 minutes |
...
![Sample problem to be solved](images/figure1.png)
...
![Mini-Grid toolbar](images/figure2.png)
...
## 5 Assigning IBOUND Values Directly to Cells
...
![Highlight the first two layers](images/figure3.png)
...
![Constant head cells marked on the left](images/figure4.png)
...
![Location of drain cells (green circles)](images/figure6.png)
...
![Color fill contours with a legend](images/figure11.png)
...
### 13.2 Viewing the Zone Budget Report
